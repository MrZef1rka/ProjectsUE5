...
void ALMADefaultCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Jump", IE_Pressed, this, &ALMADefaultCharacter::Jump);
...
void ALMADefaultCharacter::MoveJump(float Value)
{
...
void ALMADefaultCharacter::ZoomCamera(float Value)
{
	if (SpringArmComponent && FMath::Abs(Value) > 0.1f)
	{
		...
		CurrentZoomDistance -= Value * ZoomSpeed;
